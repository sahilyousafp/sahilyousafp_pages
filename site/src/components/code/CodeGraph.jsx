...
const INIT_NODES = [
  ...
  { id: 'citylayers', label: 'City Layers', icon: 'public', type: 'sub', cat: 'experience', x: 68, y: 76, parent: 'experience', line: 'dashed', link: 'https://app.citylayers.eu/' },
  { id: 'iaac', label: 'IAAC Barcelona', icon: 'school', type: 'sub', cat: 'experience', x: 70, y: 84, parent: 'experience', line: 'dashed', scrollTo: 'code-exp' },
...
const DETAILS = {
  ...
  experience: { title: 'Experience & Path', text: 'From Morphogenesis and SHAPE to DNEG, IAAC Barcelona, and City Layers Vienna — bridging architectural practice with computational research.' },
  citylayers: { title: 'City Layers — AI Research Intern', text: 'TU Wien spin-off building a participatory spatial data platform. SQL→Neo4j data migration, agentic LLM framework from scratch, FastAPI + TypeScript deployment, GCP infrastructure. Contributed to pre-seed investment round.' },
