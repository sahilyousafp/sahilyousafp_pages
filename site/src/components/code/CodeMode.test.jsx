...
vi.mock('../../data', () => ({
  codeProjects: [
    { title: 'Project A', link: 'https://example.com/a', img: '', tags: '', desc: '' },
    { title: 'Project B', link: 'https://example.com/b', img: '', tags: '', desc: '' },
  ],
  publications: [
    { t: 'Pub One', conf: 'Conf', d: '2024', c: 'sub', desc: '', u: 'https://example.com/pub' },
  ],
  blogs: [
    { t: 'Blog One', c: 'cat', d: '2024', img: '', u: 'https://example.com/blog' },
  ],
  codeExp: [
    { type: 'Work', date: '2024', role: 'Engineer', desc: '', link: 'https://example.com/exp' },
...
describe('CodeMode analytics tracking', () => {
  ...
  it('tracks project card clicks', () => {
    ...
    expect(track).toHaveBeenCalledWith('Project Click', { project: 'Project A' });
  });
  ...
  it('tracks publication card click', () => {
    ...
    fireEvent.click(pub);
    expect(track).toHaveBeenCalledWith('Publication Click', { title: 'Pub One' });
  });
  ...
  it('tracks experience row click only when link present', () => {
    ...
    fireEvent.click(exp);
    expect(track).toHaveBeenCalledWith('Experience Click', { role: 'Engineer' });
  });
  ...
  it('tracks contact email click', () => {
    render(<CodeMode onBack={() => {}} />);
    const email = screen.getByRole('link', { name: /sahil.yousaf@students.iaac.net/ });
