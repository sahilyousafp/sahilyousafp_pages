...
export default function TargetCursor({
  ...
  useEffect(() => {
    ...
    const onTargetEnter = (e) => {
      ...
      gsap.to(tlRef.current, { top: 0, left: 0, duration: hoverDuration, ease: 'power2.out' });
      gsap.to(trRef.current, { top: 0, right: 0, duration: hoverDuration, ease: 'power2.out' });
      gsap.to(blRef.current, { bottom: 0, left: 0, duration: hoverDuration, ease: 'power2.out' });
      gsap.to(brRef.current, { bottom: 0, right: 0, duration: hoverDuration, ease: 'power2.out' });
    ...
    const onTargetLeave = () => {
      ...
      gsap.to(tlRef.current, { top: 4, left: 4, duration: hoverDuration, ease: 'power2.out' });
      gsap.to(trRef.current, { top: 4, right: 4, duration: hoverDuration, ease: 'power2.out' });
      gsap.to(blRef.current, { bottom: 4, left: 4, duration: hoverDuration, ease: 'power2.out' });
      gsap.to(brRef.current, { bottom: 4, right: 4, duration: hoverDuration, ease: 'power2.out' });
